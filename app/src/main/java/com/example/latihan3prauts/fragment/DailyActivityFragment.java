...
public class DailyActivityFragment extends Fragment {
    ...
    public DailyActivityFragment() {
        FriendModel us1 = new FriendModel(R.drawable.instagram, "Kaizer_Nugraha", "instagram");
        FriendModel us2 = new FriendModel(R.drawable.gmail, "nugrahakaizer@gmail.com", "gmail");
        FriendModel us3 = new FriendModel(R.drawable.whatsapp, "08782405752", "whatsapp");
        FriendModel us4 = new FriendModel(R.drawable.youtube, "kaizerNugraha", "youtube");
        FriendModel us5 = new FriendModel(R.drawable.facebook, "Kaizer Nugraha", "facebook");
